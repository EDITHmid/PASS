...
> **Early-warning intelligence for higher education**
> A data-driven web application that turns raw assignment submission data into credibility insights &mdash; flagging at-risk students 4&ndash;6 weeks before grade collapse.
...
This project is released as an open-source tool for educational institutions. It is free to use, modify, and deploy under the MIT License.

---

*Built with care for students, instructors, and the institutions that serve them.*
